...
{
    return(
        <div className="w-40 md:w-[180px] lg:w-[200px] h-auto cursor-pointer">
            <img src={testImg} className="w-40 h-40 md:w-[180px] md:h-[180px] lg:w-[200px] lg:h-[200px] object-cover rounded-lg"/>
            <div className="mt-2">
